...
public class ClipperInsertarResultadoDAO implements InsertarResultadoDAO{
    ...
    public void insertar(String perAcad,String codAlu, String codCur, String seccion,double promPra,int notPar,int notFin, int notSus,int recPar,int recFin,int recSus) throws TransactionException{
    	Connection c = null;
	...
	public int insertIntoMatriClipper(String cursoId, String seccion,String codAlumno,String perAcad,String notfin, String recfin, String notpar, String recpar, String notsus, String recsus, String prom, String promnum) throws TransactionException {
		Connection c = null;
		...
		//String kuery="UPDATE MATR062 SET NOTPAR=18 WHERE CODALU='20064533D' AND CODCUR='AU511' AND SECCION='A'";
