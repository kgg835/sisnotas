...
public class ConsultaManager {
	...
	public ArrayList<String> getAllTipoPrueba(String codCur, String seccion,
			String perAcad) throws TransactionException {
	...
	public ArrayList<String> getAllTipoPruebaHist(String codCur,
			String seccion, String perAcad) throws TransactionException {
		MysqlTransaction t = new MysqlTransaction(dataSource);
	...
	public ArrayList<String> getAllAlumno(String codCur, String seccion,
			String perAcad) throws TransactionException {
		MysqlTransaction t = new MysqlTransaction(dataSource);
	...
	public ArrayList<String> getAllAlumnoHist(String codCur, String seccion,
			String perAcad) throws TransactionException {
		MysqlTransaction t = new MysqlTransaction(dataSource);
	...
	public ArrayList<String> getAllPrueba(String codCur, String seccion,
			String perAcad) throws TransactionException {
		MysqlTransaction t = new MysqlTransaction(dataSource);
	...
	public ArrayList<String> getAllPruebaHist(String codCur, String seccion,
			String perAcad) throws TransactionException {
		MysqlTransaction t = new MysqlTransaction(dataSource);
