...
public class CursoManager
{
            ...
            throws TransactionException
    {
        ...
        try
        {
            DAOFactory mysqlFactory = DAOFactory.getDAOFactory(DAOFactory.MYSQL);
            CursoDAO cursoDAO = mysqlFactory.getCursoDAO(t);
            list = cursoDAO.obtenerParametros(codigoCurso, seccion, codTipoPrueba);
        }
        catch (TransactionException e)
        {
            e.printStackTrace();
    ...
    public Integer updateParametros(String codigoCurso, String seccion, ArrayList<PruebaTO> pruebas)
            throws TransactionException
    {
        MysqlTransaction t = new MysqlTransaction(dataSource);
        Integer num = null;
     ...
     * datos"); } finally { t.close(); } return n; <<<<<<< CursoManager.java }
     */
    public ArrayList<CursoTO> obtieneCursos(UsuarioTO usuario, String perAcad) throws TransactionException
    {
        MysqlTransaction t = new MysqlTransaction(dataSource);
    ...
    /**
     * VERIFICA TODAS LAS PRUEBAS DE DICHO CURSO SI NO HAY PENDIENTES ACTUALIZA
     * ESTADO DEL CURSO
     **/
    public void verificaPruebasCurso(String cursoId, String seccion) throws TransactionException
    {
        ...
        try
        {
            ...
            {
                System.out
                        .println("Se actualizó el estado del curso seccion y se calculo promedio de las practicas del curso.");
            }
            else
            {
    ...
    /**
     * ACA ENTRA TU PARTE. YO LLAMO A TU PROCEDURE CALCULA PROMEDIO CURSO
     * SECCION
     */
