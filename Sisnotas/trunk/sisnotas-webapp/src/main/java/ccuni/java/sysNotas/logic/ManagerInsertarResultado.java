...
public class ManagerInsertarResultado
{
    ...
    public int insertar(String cursoId, String seccion, String codAlumno, String perAcad, String notfin, String recfin,
            String notpar, String recpar, String notsus, String recsus, String prom, String promnum)
            throws TransactionException
    {
        ...
        try
        {
            ...
            ind = insertarResultadoDAO.insertIntoMatriClipper(cursoId, seccion, codAlumno, perAcad, notfin, recfin,
                    notpar, recpar, notsus, recsus, prom, promnum);
        }
